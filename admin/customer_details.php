        ...
        <div class="table-responsive">
            <table class="material-table">
                <tbody>
                    ...
                    <tr>
                        <td style="font-weight:600; color:#64748b;">Mobile Number</td>
                        <td>
                            <?php if (!empty($row['phone'])): ?>
                                <a href="tel:<?php echo htmlspecialchars($row['phone']); ?>" style="color:#0f766e; font-weight:700; text-decoration:none;">
                                    <i class="fa-solid fa-phone" style="margin-right:6px;"></i><?php echo htmlspecialchars($row['phone']); ?>
                                </a>
                            <?php else: ?>
